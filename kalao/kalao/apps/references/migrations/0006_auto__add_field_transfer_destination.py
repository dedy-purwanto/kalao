...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transfer.destination'
        db.add_column('references_transfer', 'destination',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.CountryDestination'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transfer.destination'
        db.delete_column('references_transfer', 'destination_id')
