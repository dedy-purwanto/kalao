...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PackageHotel.length_of_stay'
        db.delete_column('packages_packagehotel', 'length_of_stay')

        # Deleting field 'PackageHotel.add_on_breakfast'
        db.delete_column('packages_packagehotel', 'add_on_breakfast')

        # Adding field 'PackageHotel.number_of_nights'
        db.add_column('packages_packagehotel', 'number_of_nights',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PackageHotel.number_of_bonus_nights'
        db.add_column('packages_packagehotel', 'number_of_bonus_nights',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'PackageHotel.length_of_stay'
        raise RuntimeError("Cannot reverse this migration. 'PackageHotel.length_of_stay' and its values cannot be restored.")
        ...
        # Deleting field 'PackageHotel.number_of_nights'
        db.delete_column('packages_packagehotel', 'number_of_nights')

        # Deleting field 'PackageHotel.number_of_bonus_nights'
        db.delete_column('packages_packagehotel', 'number_of_bonus_nights')
    ...
    models = {
        ...
        'packages.packagehotel': {
            ...
            'number_of_bonus_nights': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'number_of_nights': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'references.transfer': {
            ...
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'destination': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['references.CountryDestination']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
