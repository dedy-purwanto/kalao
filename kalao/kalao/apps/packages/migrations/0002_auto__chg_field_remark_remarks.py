...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Remark.remarks'
        db.alter_column('packages_remark', 'remarks', self.gf('django.db.models.fields.CharField')(max_length=2048))

    def backwards(self, orm):

        # Changing field 'Remark.remarks'
        db.alter_column('packages_remark', 'remarks', self.gf('django.db.models.fields.TextField')())
