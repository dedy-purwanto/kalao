...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PackageHotel.active'
        db.delete_column('packages_packagehotel', 'active')

        # Deleting field 'Remark.active'
        db.delete_column('packages_remark', 'active')


    def backwards(self, orm):
        # Adding field 'PackageHotel.active'
        db.add_column('packages_packagehotel', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Remark.active'
        db.add_column('packages_remark', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
