...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'hotels_hotel', 'stars')

        # Adding field 'Hotel.star'
        db.add_column(u'hotels_hotel', 'star',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Star'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Hotel.stars'
        db.add_column(u'hotels_hotel', 'stars',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Hotel.star'
        db.delete_column(u'hotels_hotel', 'star_id')
    ...
    models = {
        ...
        u'hotels.hotel': {
            ...
            'star': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['references.Star']", 'null': 'True', 'blank': 'True'})
        },
        u'hotels.rate': {
        ...
        u'references.star': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'star_created'", 'to': u"orm['auth.User']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'star_modified'", 'to': u"orm['auth.User']"}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'})
        }
    }
