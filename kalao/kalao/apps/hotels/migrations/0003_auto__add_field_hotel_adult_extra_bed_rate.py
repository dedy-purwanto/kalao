...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hotel.adult_extra_bed_rate'
        db.add_column('hotels_hotel', 'adult_extra_bed_rate',
                      self.gf('django.db.models.fields.DecimalField')(default=200, max_digits=30, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hotel.adult_extra_bed_rate'
        db.delete_column('hotels_hotel', 'adult_extra_bed_rate')
